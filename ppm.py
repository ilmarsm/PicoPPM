...
class Servo:
    ...
    # My values
    __min_u16_duty = 1640 - 2  # offset for correction
    __max_u16_duty = 8200 - 0  # offset for correction
    min_angle = 0
    max_angle = 180
    current_angle = 0.001

    def __init__(self, pin, base_angle):
        self.__initialise(pin, base_angle)

    def update_settings(self, servo_pwm_freq, min_u16_duty, max_u16_duty, min_angle, max_angle, pin, base_angle):
